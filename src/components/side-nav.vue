...
<div id="sidebar-menu">
    ...
    <ul id="side-menu" class="metismenu list-unstyled">
        ...
        <template v-for="item in menuItems">
            <li class="menu-title" v-if="item.isTitle && item.roles.includes(data.user.TYPE)" :key="item.id">
                {{ $t(item.label) }}
            </li>
            <li v-if="!item.isTitle && !item.isLayout && item.roles.includes(data.user.TYPE)" :key="item.id">
